export default function Menu() {
    ...
    <div >
        <div className="row1" >
            <div ><img src="coldcoffee.png" alt="" className="row1a" /> <p>Cold Coffee</p></div>
            <div ><img src="hotcoffee.png" alt="" className="row1a" /> <p>Hot Coffee</p></div>
        </div>
    </div>
    <div className="row1" >
            <div ><img src="hottea.png" alt="" className="row1a" /> <p>Hot Tea</p></div>
            <div ><img src="coldtea.png" alt="" className="row1a" /> <p>Cold Tea</p></div>
    </div>
